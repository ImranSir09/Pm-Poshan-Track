                ...
                <>
                    <Card title="Monthly Totals">
                        <div className="grid grid-cols-3 gap-4 text-center">
                            <div>
                                <p className="text-xs text-stone-500 dark:text-gray-400">Total Days</p>
                                <p className="text-lg font-bold text-amber-700 dark:text-amber-400">{monthEntries.length}</p>
                            </div>
                            <div>
