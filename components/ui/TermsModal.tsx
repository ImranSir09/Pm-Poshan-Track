...
const TermsModal: React.FC<TermsModalProps> = ({ isOpen, onClose }) => {
    return (
        <Modal isOpen={isOpen} onClose={onClose} title="Terms and Conditions" zIndex="z-[60]">
            <div className="space-y-3 max-h-[60vh] overflow-y-auto pr-2 text-sm text-stone-600 dark:text-gray-300">
                ...
                <h4 className="font-bold text-amber-700 dark:text-amber-400">1. Acceptance of Terms</h4>
                ...
                <h4 className="font-bold text-amber-700 dark:text-amber-400">2. Description of Service</h4>
                ...
                <h4 className="font-bold text-amber-700 dark:text-amber-400">3. Data Privacy and Storage</h4>
                <p>
                ...
                <h4 className="font-bold text-amber-700 dark:text-amber-400">4. User Account and Security</h4>
                ...
                <h4 className="font-bold text-amber-700 dark:text-amber-400">5. User Responsibilities</h4>
                ...
                <h4 className="font-bold text-amber-700 dark:text-amber-400">6. Disclaimer of Warranties</h4>
                ...
                <h4 className="font-bold text-amber-700 dark:text-amber-400">7. Limitation of Liability</h4>
                ...
                <h4 className="font-bold text-amber-700 dark:text-amber-400">8. Changes to Terms</h4>
                ...
                <h4 className="font-bold text-amber-700 dark:text-amber-400">9. Contact Information</h4>
