...
const IllustrationCard: React.FC<IllustrationCardProps> = ({ inchargeName, inchargeContact }) => {
    ...
    return (
        <Card className="!p-0 overflow-hidden relative bg-gradient-to-br from-amber-400 to-orange-500 dark:from-cyan-900/50 dark:to-blue-900/50">
            <div className="p-4 relative z-10">
                <div className="flex justify-between items-start">
                    <div>
                        <h2 className="text-lg font-bold text-white">Welcome!</h2>
                        <p className="text-sm text-amber-100 dark:text-gray-300 max-w-xs">
                     ...
                     {showInchargeDetails && (
                        <div className="text-right text-xs flex-shrink-0 ml-2">
                            ...
                            <p className="text-amber-200 dark:text-gray-400">MDM Incharge</p>
                            {inchargeContact && <p className="text-amber-200 dark:text-gray-400">{inchargeContact}</p>}
                        </div>
                    )}
                </div>
            </div>
            <div className="absolute inset-0 z-0 opacity-20 dark:opacity-40">
                <svg width="100%" height="100%" viewBox="0 0 300 120" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg">
                    ...
                    {/* Abstract ground */}
                    <path d="M -10 120 Q 150 90, 310 120" fill="#7c2d12" opacity="0.5" />

                    {/* School building */}
                    <g transform="translate(40, 60)" fill="#fef3c7" opacity="0.8">
                        <path d="M 0 60 L 0 20 L 25 0 L 50 20 L 50 60 Z" />
                        <rect x="15" y="35" width="20" height="25" fill="#d97706" />
                    </g>
                    
                    {/* Abstract child figures */}
                    <g transform="translate(130, 75)" fill="#fcd34d" opacity="0.9">
                       <circle cx="10" cy="10" r="6" />
                       <path d="M 10 16 A 10 10 0 0 1 10 35 A 10 10 0 0 1 10 16 Z" />
                    </g>
                     <g transform="translate(160, 80)" fill="#fef3c7" opacity="0.8">
                       <circle cx="10" cy="10" r="5" />
                       <path d="M 10 15 A 8 8 0 0 1 10 30 A 8 8 0 0 1 10 15 Z" />
                    </g>

                     {/* Book Icon */}
                    <g transform="translate(200, 85) scale(0.3)" fill="#fefce8">
                        <path d="M2,2 L2,28 L15,24 L28,28 L28,2 L15,6 L2,2 Z M15,6 L15,24" stroke="#fde68a" strokeWidth="3"/>
                    </g>
